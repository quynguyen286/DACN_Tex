\subsubsection{Use case: Giám sát và Phân tích Hệ thống}
\begin{figure}[H]
    \centering
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{3.2cm}|p{11.5cm}|}
        \hline
        \textbf{Mã số usecase} & UC-01: Giám sát và Phân tích Hệ thống \\
        \hline
        ...
        \hline
        \textbf{Tiền điều kiện} & Tài khoản Admin đã đăng nhập và có quyền truy cập module Giám sát. \\
        \hline
        \textbf{Hậu điều kiện} & Dữ liệu thống kê được hiển thị đầy đủ và cập nhật mới nhất. \\
        \hline
        \textbf{Trigger} & Admin nhấn chọn menu ``Giám sát \& Thống kê'' trên thanh điều hướng. \\
        \hline
        \textbf{Luồng chính} &
...
\subsubsection{Use case: Quản lý Báo cáo}
\begin{figure}[H]
    \centering
