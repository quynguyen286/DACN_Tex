...
\begin{table}[H]
    ...
    \label{tab:tradeoff}
    % 1. Tăng khoảng cách dòng lên 1.3 hoặc 1.5 cho dễ đọc
    \renewcommand{\arraystretch}{1.5} 
    
    % 2. Định nghĩa lại cột X để tự động xuống dòng nhưng CĂN TRÁI (không bị giãn chữ)
    % Cấu trúc: | p{chiều_rộng_cố_định} | >{\raggedright\arraybackslash}X | >{\raggedright\arraybackslash}X |
